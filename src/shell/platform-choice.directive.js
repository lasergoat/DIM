...
.directive('dimPlatformChoice', 

  ['$scope', 'dimBungieService', 'dimUserSystemIds', 'dimConfig', '$window',

  function($scope, dimBungieService, dimUserSystemIds, dimConfig, $window) {
    ...
    return {
      ...
      controller: function() {
        ...
        function update() {
          ...
          var getItemType = function(type, name) {
          ...
          var getItems = function(owner, items, definitions) {
